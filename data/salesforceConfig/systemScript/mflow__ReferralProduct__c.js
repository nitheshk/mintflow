...
let objectName = "mflow__ReferralProduct__c";
...
utils
  ...
  .then((result) => {
    ...
    data.forEach(function (item, index) {
      ...
      item.attributes.referenceId = "ReferralProductRef" + index;
      ...
      if (item.mflow__CrossSellProduct__c) {
        item.mflow__CrossSellProduct__c = "@" + item.mflow__CrossSellProduct__r.mflow__InternalCode__c;
