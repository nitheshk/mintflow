...
export default class DealerRegSignatureCapture extends LightningElement {
  @api dealerRecord;
  ...
  renderedCallback() {
    ...
    if (this.dealerRecord?.id && !this.isRendered) {
...
*/
  ...
  handlePrev() {
    customDispatchEvent(this, "signaturecapturechange", {
